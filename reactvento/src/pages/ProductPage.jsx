...
export default function ProductPage() {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        setLoading(true)
        let response = await apiRequest(`${window.siteUrl}/index.php?route=product/product&language=en-gb&product_id=${productId}&api=true`)
        ...
        <div className="flex flex-col space-y-4 lg:w-1/2 w-full">
          {isVideo(mainImage) ? (
            ...
            >
              ...
              <source src={mainImage} type="video/avi" />
